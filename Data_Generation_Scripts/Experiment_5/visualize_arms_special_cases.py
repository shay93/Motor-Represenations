...
output_dir = data_dir + "Visualizations_Special_Cases/"
...
#now sort the actions to get the strange edge cases
sorted_idx = np.argsort(actions_2DOF,axis = 0)
subset_idx = np.concatenate((sorted_idx[:20,0],\
                             sorted_idx[-20:,0],
                             sorted_idx[:20,1],
                             sorted_idx[-20:,1]))
