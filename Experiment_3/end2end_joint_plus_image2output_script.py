...
from model_classes import onetstep_observed_joint_plus_image_to_output
import numpy as np
import os
import pickle
...
num_samples = 20000
root_dir = "end2end_onetstep_joint_plus_image/"
learning_rate = 1e-3
...
saved_variable_directory = "joint_plus_image2image/" + "model/" + "model.ckpt"
...
model_graph = onetstep_observed_joint_plus_image_to_output(learning_rate)
#build the graph
